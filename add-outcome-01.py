...
input_file2 = sys.argv[2] # path/to/file.txt with the list of genes with known association
output_file = sys.argv[3] # path/to/file.txt to save output

# Check input
helpers.check_input([input_file1, input_file2])    
